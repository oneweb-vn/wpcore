...
add_action( 'after_setup_theme', 'wpcore_block_editor_setup' );

if ( ! function_exists( 'wpcore_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function wpcore_block_editor_setup() {
		...
		$color_palette = wpcore_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'wpcore_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function wpcore_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'wpcore_theme_editor_color_palette', $color_palette );
	}
}
