...
if ( ! function_exists( 'wpcore_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use wpcore_customize_sanitize_select()
	 * @see wpcore_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function wpcore_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'wpcore_customize_sanitize_select' );
		return wpcore_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'wpcore_adjust_body_class' ) ) {
	 ...
	 */
	function wpcore_adjust_body_class( $classes ) {
		_deprecated_function( 'wpcore_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'wpcore_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function wpcore_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'wpcore_slbd_count_widgets', '0.8.9', 'wpcore_widget_classes' );
