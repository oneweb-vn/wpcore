...
if ( ! function_exists( 'wpcore_pagination' ) ) {
	/**
	 ...
	 */
	function wpcore_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => _x( '&laquo;', 'previous set of posts', 'wpcore' ),
				'next_text'          => _x( '&raquo;', 'next set of posts', 'wpcore' ),
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'wpcore' ),
			)
		);
